...
- **Plugin window:** Resizable (default 1280x720, limits 640x360 to 2560x1440). CSS uses `clamp()` for responsive adaptation. Window size persisted in APVTS ValueTree.
