...
* Needs at least two oscillators with basic tuning and octave shifts  
* An amplifier envelope  
* Filter types 12 and 24 dB low-pass, maybe high-pass too  
* Filter envelope  
* LFO that can have targets to modulate  
* Unison  
